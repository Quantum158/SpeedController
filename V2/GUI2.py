...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.AHalf.setStyleSheet("background-color: rgb(0, 0, 255);")
...
"text-decoration: underline;")
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(0, 380, 261, 186))
        ...
        self.formLayout_2.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout)
        self.horizontalLayout_3.addWidget(self.widget_3)
        self.BHalf = QtWidgets.QWidget(self.horizontalLayoutWidget)
        self.BHalf.setEnabled(True)
        self.BHalf.setStyleSheet("background-color: rgb(255, 0, 0);")
