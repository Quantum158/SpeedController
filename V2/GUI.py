...
"(Left Arrow)"))
        ...
        self.RecordSpin.setToolTip(_translate("MainWindow", "<html><head/><body><p>Camera will automatically stop recording after said time</p><p>`0` means this is disabled</p></body></html>"))
        self.RecordSpin.setSuffix(_translate("MainWindow", "   Second(s)"))
        ...
        self.StageDelaySpin.setSuffix(_translate("MainWindow", "   Second(s)"))
        ...
        self.PacerBeepsSpin.setSuffix(_translate("MainWindow", "   Second(s)"))
